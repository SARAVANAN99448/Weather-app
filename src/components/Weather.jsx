...
const Weather = () => {
    ...
    return (<>
        ...
        <div className=" p-28  flex justify-center items-center  " style={{backgroundImage:`url(${image})`,width:"100%",height:"641px",backgroundSize:"cover",backgroundRepeat:"no-repeat"}} >
            <div className="bg-[#d4d2c7] p-10 flex flex-col gap-3 rounded-xl w-80  shadow-md shadow-black border border-black " style={{height:"350px"}}>
